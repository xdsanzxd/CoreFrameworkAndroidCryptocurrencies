...
public class Constantes {
    ...
    public static final double PURCHASE_PRICE_SATOCHIS_OMG = .00021;
    public static final String lun = "LUN";
    public static final double PURCHASE_PRICE_DOLLAR_LUN = .225;
    public static final double PURCHASE_PRICE_SATOCHIS_LUN = .0002298;
    public static final String neo = "NEO";
    public static final double PURCHASE_PRICE_DOLLAR_NEO = .138;
    public static final double PURCHASE_PRICE_SATOCHIS_NEO = .001413;

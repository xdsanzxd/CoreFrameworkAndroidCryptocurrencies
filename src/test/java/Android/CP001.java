...
public class CP001 extends Data {
    ...
    @Test(testName = "Android.CP001", description = "Open the app and get the information with screenshot of the parcentajes in 24 hrs. Saving the screenshot with current date." +
